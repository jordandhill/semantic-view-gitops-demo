...
-- DEVELOPMENT (SANDBOX_DEV.PUBLIC)
CREATE DATABASE IF NOT EXISTS SANDBOX_DEV
  COMMENT = 'Development environment for semantic views';
GRANT USAGE ON DATABASE SANDBOX_DEV TO ROLE CICD_SEMANTIC_VIEWS;
GRANT USAGE ON SCHEMA SANDBOX_DEV.PUBLIC TO ROLE CICD_SEMANTIC_VIEWS;
GRANT CREATE SEMANTIC VIEW ON SCHEMA SANDBOX_DEV.PUBLIC TO ROLE CICD_SEMANTIC_VIEWS;
...
GRANT EXECUTE MANAGED TASK ON ACCOUNT TO ROLE CICD_SEMANTIC_VIEWS;
-- PROD
...
-- DEV
GRANT CREATE TASK ON SCHEMA SANDBOX_DEV.PUBLIC TO ROLE CICD_SEMANTIC_VIEWS;
GRANT CREATE DATASET ON SCHEMA SANDBOX_DEV.PUBLIC TO ROLE CICD_SEMANTIC_VIEWS;
GRANT CREATE STAGE ON SCHEMA SANDBOX_DEV.PUBLIC TO ROLE CICD_SEMANTIC_VIEWS;
